...
// newPersonaTestScheme builds a runtime scheme with the core and Sympozium
// types registered for the fake client used by the persona-routing tests.
func newPersonaTestScheme(t *testing.T) *runtime.Scheme {
	t.Helper()
